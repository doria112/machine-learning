...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            # self.epsilon -= 0.05
            # self.epsilon = math.pow(self.number_trial, -2)
            # self.epsilon = math.pow(self.a, self.number_trial) # a = 0.9
            # self.epsilon = math.exp(-self.a * self.number_trial) # a = 0.1
            self.epsilon = math.cos(self.a * self.number_trial) # a = 0.01
